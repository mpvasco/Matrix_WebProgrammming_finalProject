...
function modificar() {
  ...
  element.innerHTML =   `<h2 class="quiz" style='color: blue; font-size: 90px; background-color: #f7b605; padding: 30px; border-radius: 10px; margin-top: 30px;'>You got ${fscore}%</h2>`
  element.style.textAling = 'center';
  document.getElementById("tryA").style.display = 'block';
  // document.getElementById("tryA").style.textAlign = 'center';
}
